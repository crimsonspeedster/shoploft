<div class="overlays modalOverlay">
    ...
    <div class="modal" id="modal" data-modal="addProduct">
        ...
        <p class="added">Товар доданий до кошика</p>
        <p>У вас у кошику <span class="goods-count">1</span> товар</p>
        <div class="modal-buttons">
            <button class="confirm-btn">Продовжити покупки </button>
            <button class="exit-btn" >Оформити замовлення</button>
        </div>
    </div>
    ...
    <div class="modal" id="modalThank" data-modal="Thanks">
        ...
        <p class="added">Дякуємо за реєстрацію!</p>
        <p>Вам було надіслано листа з реєстраційною інформацією.</p>
        <div class="modal-buttons">
            <a href="#" class="logo-wrap" aria-label="Homepage">
                <img class="logo" src="images/icons/logo.svg" alt="Company Logo" />
            </a>
        </div>
    </div>
